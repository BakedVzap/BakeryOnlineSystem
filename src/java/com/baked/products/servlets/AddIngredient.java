...
public class AddIngredient extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String ingredName=(String)request.getAttribute("ingredName");
        String quantity=(String)request.getAttribute("quantity");
        
        Double quant = Double.parseDouble(quantity);
        Ingredient ingred = new Ingredient(ingredName, quant);
        System.out.println(ingred.toString());
        RequestDispatcher rd = sc.getRequestDispatcher("addIngredient.jsp");
